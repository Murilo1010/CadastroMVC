...
<form action="../Controller/Navegacao.php" method="post" class="w3-container w3-card-4  w3-text-orange w3-margin w3-display-middle" style="width: 30%;">
     <h2 class="w3-center w3-text-orange">Primeiro Acesso</h2>
 	<div class="w3-row w3-section">
        <div class="w3-col" style="width:11%;">
            <i class="w3-xxlarge fa fa-user w3-text-orange"></i>
        </div>
        <div class="w3-rest">
    ...
    <div class="w3-row w3-section">
        <div class="w3-col" style="width:11%;">
            <i class="w3-xxlarge fa fa-drivers-license w3-text-orange"></i>
        </div>
        <div class="w3-rest">
    ...
    <div class="w3-row w3-section">
        <div class="w3-col" style="width:11%;">
            <i class="w3-xxlarge fa fa-envelope-o w3-text-orange"></i>
        </div>
        <div class="w3-rest">
	...
	<div class="w3-row w3-section">
        <div class="w3-col" style="width:11%">
            <i class="w3-xxlarge fa fa-lock w3-text-orange"></i>
        </div>
		<div class="w3-rest">
