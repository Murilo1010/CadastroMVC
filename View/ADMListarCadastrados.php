            ...
            <thead>
                <?php
                    ...
                    while($row = $results->fetch_object()) {
                        ...
                        <button name="btnVisualizar" class="w3-button w3-block  w3-orange   w3-cell w3-round-large">
...
<div class="w3-padding-128 w3-content w3-text-grey">
	<form action="/Controller/navegacao.php" method="post" class="w3-container  w3-text-orange w3-margin w3-center" style="width: 30%;">
		<div class="w3-row w3-section">
			<div>
				<button name="btnVoltar" class="w3-button w3-block w3-margin w3-orange w3-cell w3-round-large" style="width: 90%;">
					Voltar
				</button>
			</div>
		</div>
