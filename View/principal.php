...
<nav class="w3-sidebar w3-bar-block w3-center w3-blue ">
        ...
        <a href="#oFormacao" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-hover-text-cyan w3-text-light-grey">
            <i class="fa fa-line-chart w3-xlarge"></i>
            <p>Outras Formações</p>
        </a>
		<a href="../View/logout.php" class="w3-bar-item w3-button w3-block n w3-cell w3-hover-light-grey w3-hover-text-cyan w3-text-light-grey">
...
<div class="w3-padding-large" id="main">
    ...
    <header class="w3-container w3-padding-32 w3-center " id="home">
        ...
        <a class="w3-text-orange"href="http://www.freepik.com">Designed by brgfx / Freepik</a>
        <br>
    ...
    <div class="w3-padding-128 w3-content w3-text-grey" id="dPessoais">
        <h2 class="w3-text-orange">Dados Pessoais</h2>
        
        <form action="../Controller/Navegacao.php" method="post" class=" w3-row   w3-text-orange w3-margin" style="width: 100%;">
        <input class="w3-input w3-border w3-round-large" name="txtID" type="hidden"
            ...
            <div class="w3-row w3-section">
                <div class="w3-center" style="">
                    <button name="btnAtualizar" class="w3-button w3-block w3-margin w3-blue w3-cell w3-round-large  w3-text-orange" style="width: 90%;">Atualizar</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="w3-padding-128 w3-content w3-text-grey" id="formacao">
        <h2 class=" w3-text-orange">Formação</h2>
        



        <form action="../Controller/Navegacao.php" method="post" class=" w3-row  w3-text-blue w3-margin" style="width:100%;">
            <div class="w3-row w3-center">
                <div class="w3-col w3-text-orange" style="width:50%;">
                    Data Inicial
                </div>
                <div class="w3-res w3-text-orange" style="">
                    Data Final
                </div>
            </div>
            <div class="w3-row w3-section">
                <div class="w3-row w3-section w3-col" style="width:45%;">
                    <div class="w3-col" style="width:15%;">
                        <i class="w3-xxlarge fa fa-calendar  w3-text-orange"></i>
                    </div>
                    <div class="w3-rest">
            ...
            <div class="w3-row w3-section">
                <div class="w3-col" style="width:7%;">
                    <i class="w3-xxlarge fa fa-align-justify  w3-text-orange"></i>
                </div>
                <div class="w3-rest">
            ...
            <div class="w3-row w3-section">
                <div class="w3-center" style="">
                    <button name="btnAddFormacao" class="w3-button w3-block  w3-blue w3-cell w3-round-large  w3-text-orange" style="width: 20%;">
    ...
    <div class="w3-padding-128 w3-content w3-text-grey" id="eProfissional">
        <h2 class=" w3-text-orange">Experiência Profissional</h2>
                <form action="../Controller/Navegacao.php" method="post" class=" w3-row  w3-text-orange w3-margin" style="width: 100%;">
            <div class="w3-row w3-center">
            ...
            <div class="w3-row w3-section">
                <div class="w3-center" style="">
                    <button name="btnAddEP" class="w3-button w3-block  w3-blue w3-cell w3-round-large  w3-text-orange" style="width: 20%;">
                                    <i class="w3-xxlarge fa fa-user-plus"></i>
        ...
        <h2 class=" w3-text-orange">Outras Formações</h2>
        <form action="../Controller/Navegacao.php" method="post" class=" w3-row w3-text-orange w3-margin" style="width: 100%;">
            <div class="w3-row w3-center">
                <div class="w3-col" style="width:50%;">
                    Data Inicial
            ...
            <div class="w3-row w3-section">
                <div class="w3-center" style="">
                    <button name="btnAddOF" class="w3-button w3-block  w3-blue w3-cell w3-round-large" style="width: 20%;">
                                    <i class="w3-xxlarge fa fa-user-plus  w3-text-orange"></i>
